...
<header class="header" id="header">
    ...
    <div class="d-flex">
        <div class="header__img">
            <img decoding="async" src="{{ asset('assets/img/profile.png') }}" alt="Image">
        </div>
        <p class="mx-3 my-2" style="font-size: 18px">Hi, {{ auth()->user()->getDisplayName() }}</p>
    </div>
</header>
    ...
    <nav class="nav">
        <div>
            <a href="#" class="nav__logo">
                ...
                <span class="nav__logo-name">CMS</span>
            </a>
            <div class="nav__list">
                @if (auth()->user()->hasRole('user'))
                    <a href="/add-complaints" class="nav__link">
                        <i class='bx bx-add-to-queue nav__icon'></i>
                        <span class="nav__name">Add Complaint</span>
                    </a>
                    <a href="/my-complaints" class="nav__link">
                        <i class='bx bx-list-ul nav__icon'></i>
                        <span class="nav__name">My Complaint</span>
                    </a>
                    <a href="/edit-profile" class="nav__link">
                ...
                @if (auth()->user()->hasRole('admin'))
                    <a href="/dashboard" class="nav__link">
                        <i class="fa-regular fa-chart-bar nav__icon"></i>
                        <span class="nav__name">Dashboard</span>
                    </a>
                    <a href="/all-complaints" class="nav__link">
                        <i class="bx bx-list-ul nav__icon"></i>
                        <span class="nav__name">All Complaint</span>
                    </a>
                    <a href="/complaint-handlers" class="nav__link">
                        <i class="bx bx-user nav__icon"></i>
                        <span class="nav__name">Complaint Handlers</span>
                    </a>
                @endif
                @if (auth()->user()->hasRole('resolver'))
                    <a href="/resolver/dashboard" class="nav__link">
                        <i class=" fa-regular fa-chart-bar nav__icon" ></i>
                        <span class="nav__name">Dashboard</span>
                    </a>
                    <a href="/edit-profile" class="nav__link">
