...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card mb-4 p-3 shadow-sm" id="filterCard" style="display: none;">
            <form method="GET" action="{{ route('user.show_complain') }}">
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        <a href="{{ route('user.show_complain') }}" class="btn btn-danger w-100 me-2">Clear Filter</a>
                        ...
                        <tbody>
                            @forelse($complaints as $index => $complaint)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('complaints.edit', $complaint->id) }}" class="btn btn-warning btn-sm">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <button class="btn btn-danger btn-sm deleteComplaint" data-id="{{ $complaint->id }}">
