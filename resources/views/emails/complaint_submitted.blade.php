...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;">
    ...
    <div style="margin-top: 20px; margin-bottom: 20px; marg max-width: 600px; margin: 20px auto; background: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        ...
        <h2 style="color: #333; font-size: 18px; margin-top: 20px;">Dear {{ auth()->user()->name }},</h2>
        ...
        <ul style="list-style: none; padding: 0;">
            ...
            <li style="padding: 8px 0; border-bottom: 1px solid #ddd;"><strong style="color: #598abf;">Urgency:</strong> {{ $urgency }}</li>
            <li style="padding: 8px 0; border-bottom: 1px solid #ddd;"><strong style="color: #598abf;">Description:</strong> {{ $description }}</li>
        </ul>
